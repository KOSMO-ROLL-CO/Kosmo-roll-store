        ...
        <div className="bg-white rounded-3xl shadow-xl shadow-kosmo/5 p-8 border border-gray-100">
          <div className="text-center mb-6">
            ...
            <p className="text-cosmos/50 text-sm">
              Junte-se ao universo Kosmo Roll
            </p>
          </div>
          ...
          {earnedCoins > 0 && (
            ...
            >
              Conta criada! Você ganhou {earnedCoins} Kosmo Coin{earnedCoins > 1 ? 's' : ''}. 🪙
            </motion.div>
          )}
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                <User size={18} className="absolute left-4 top-1/2 -translate-y-1/2 text-cosmos/30" />
                <input
                  type="text"
                  value={name}
          ...
          {/* Terms */}
          <p className="text-center text-xs text-cosmos/40 mt-4">
            Ao criar uma conta, você concorda com nossos{' '}
            <a href="#" className="text-kosmo hover:underline">Termos de Uso</a>
            {' '}e{' '}
            <a href="#" className="text-kosmo hover:underline">Política de Privacidade</a>.
          </p>
          ...
          <p className="text-center text-sm text-cosmos/60">
            Já tem uma conta?{' '}
            <Link to="/login" className="text-kosmo hover:text-kosmo-dark font-semibold transition-colors">
              Faça login
            </Link>
          </p>
        </div>
